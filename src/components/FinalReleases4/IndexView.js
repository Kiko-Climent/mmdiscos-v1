...
export default function IndexView() {
  ...
  useEffect(() => {
    const measure = () => {
      ...
      if (nav) {
        setNavBottom(nav.getBoundingClientRect().bottom + 16);
      }
    };
    measure();
  ...
  const GRID = "repeat(12, minmax(0, 1fr))";
  ...
  return (
    ...
    >
      ...
      {/* Release list */}
      <div style={{ position: "relative", zIndex: 2, width: "100%", padding: `0 ${PADDING_PX}px`, boxSizing: "border-box" }}>
