...
export default function MMHeroReleasesNew2() {
  const spotlightRef       = useRef(null);
  const releasesLabelRef   = useRef(null);
  ...
  return (
    <div className="releases-wrapper">
      <style>{`
        ...
        .releases-wrapper .releases-label {
      ...
      <section className="spotlight" ref={spotlightRef}>
        <div className="releases-label font-mono" ref={releasesLabelRef}>RELEASES</div>
