...
export default function AboutFinal4() {
  ...
  return (
    <section ref={sectionRef} className="about-final-v4 relative w-full bg-white text-black">
      <div
        ref={stickyRef}
      ...
      >
        ...
        <div
          ref={editorialRef}
          className="absolute inset-0 z-20 pointer-events-none text-black flex flex-col justify-center pt-[var(--mm-nav-bottom,7rem)] lg:pt-0 lg:block"
        >
          ...
          <div
            className="lg:absolute left-0 right-0 px-6 lg:px-10 flex items-center justify-center sm:justify-between text-[11px] tracking-[0.02em] uppercase"
            style={{ top: "var(--af-irl-top)" }}
          >
            <div
              ref={topMetaLeftRef}
          ...
          <div
            ref={topRuleRef}
            className="lg:absolute lg:left-10 lg:right-10 mx-6 lg:mx-0 mt-2 lg:mt-0 h-px bg-black will-change-transform"
            style={{ top: "var(--af-rule-top)" }}
          />
          {/* Línea inferior: oculta en móvil (la reemplaza el border-b del
              último link). Visible en desktop tal cual. */}
          <div
            ref={bottomRuleRef}
              ...
              <ul className="flex flex-col">
                {LINKS.map((link, idx) => (
                  <li
                    ...
                    className="group relative flex items-center gap-4 border-t border-black py-1 lg:py-2 first:border-t-0 last:border-b lg:last:border-b-0 will-change-[transform,opacity]"
                  >
                    <span
