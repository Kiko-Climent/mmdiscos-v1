...
// Marquee — tamaño de cada portada, separacion y velocidad. Opacidad baja
// a proposito ("dejandose entrever") para que lea como textura de fondo,
// nunca compita con los titulos que van delante.
const MARQUEE_ITEM_SIZE = "clamp(220px, 24vw, 420px)";
const MARQUEE_GAP = "4px";
const MARQUEE_DURATION = "42s";
const MARQUEE_OPACITY = 0.15;
const MARQUEE_KEYFRAMES_NAME = "mm-highlights-marquee";
...
export default function NewHighlights() {
  ...
  return (
    ...
    >
      ...
      {/* Marquee de fondo — portadas en escala de grises, opacidad baja,
          en bucle continuo. Vive DETRAS de los titulos (z-index / orden
          DOM), visible por defecto y se apaga en cuanto hay un titulo en
          hover. pointer-events:none para que nunca robe el hover a los
          titulos que tiene delante. */}
      <div
        style={{
          position: "absolute",
          left: 0,
