...
const AnimationReleases3 = () => {
  ...
  useEffect(() => {
    const runAnimation = async () => {
      ...
      //-------------------------------------------------------------
      // 🔥 QUITAMOS SCROLL INTERNO
      //-------------------------------------------------------------
      artistContainer.style.overflowY = "hidden"; // <--- clave

      //-------------------------------------------------------------
      // 🔥 ESPACIO TOTAL DE SCROLL PARA RECORRER TODA LA LISTA
      //-------------------------------------------------------------
      ...
      // añade un poco de scroll extra para terminar elegante

      //-------------------------------------------------------------
      // 🔵 2º SCROLLTRIGGER → MOVER LISTA SEGÚN SCROLL GLOBAL
      //-------------------------------------------------------------
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          // 🔥 SCROLL GLOBAL → DESPLAZA LA LISTA
      ...
      <section className="center-section relative w-full min-h-[100svh] p-4 overflow-hidden bg-white">
        ...
        <div className="artist-list-wrapper absolute inset-0 opacity-0 pointer-events-auto z-[5]">
          ...
          <div className="artist-center-img absolute inset-0 flex items-center justify-center pointer-events-none z-[10]">
            ...
            <img
              id="artist-active-image"
              src=""
              className="w-[clamp(20rem,25vw,40rem)]
                aspect-[1/1] object-cover absolute mix-blend-normal"
            />
          </div>
...
export default AnimationReleases3;
