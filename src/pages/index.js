...
export default function Home() {
  ...
  useLayoutEffect(() => {
    ...
    if (onMobile) {
      ...
      // NO usar ScrollTrigger.normalizeScroll(true) en iOS/Safari móvil: el normalizador
      // intercepta touch/scroll y ha provocado excepciones en cliente junto a ScrollTrigger
      // y listeners globales. ignoreMobileResize (arriba) ya mitiga cambios de viewport.
